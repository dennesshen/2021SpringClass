...
public class MyLoggerAspect {
		...
		@Pointcut(value = "execution(public Integer com.study.spring.case5.aop.CalcImpl.*(..))")
		public void pt1() {}
		
		@Pointcut(value = "execution(public Integer com.study.spring.case5.aop.CalcImpl.div(..))")
		public void pt2() {}
		
		//前置通知
		//指定特定類特定方法
		//@Before(value = "execution( public int com.study.spring.case5.aop.CalcImpl.add(int, int) )")
		//指定特定類所有方法
		//@Before(value = "execution( public int com.study.spring.case5.aop.CalcImpl.*(..) )")
